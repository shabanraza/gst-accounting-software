      ...
      <table className="w-full border-collapse border border-black text-[11px]">
        <tbody>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex min-w-0 items-start gap-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <p>
                      State:{' '}
                      {stateLabel(company.stateCode) || company.stateCode}
                    </p>
          ...
          {(document.poReference ||
            ...
            <tr>
              ...
              <td className={cell} colSpan={cols - 1}>
                {[
                  document.poReference
                    ? `PO/Ref: ${document.poReference}`
                    : null,
                  document.challanRef
                    ? `Challan: ${document.challanRef}`
                    : null,
                  document.transportMode
            ...
            <td className={cell} colSpan={isInterState ? 6 : 7}>
              ...
              <table className="w-full border-collapse border border-black text-[10px]">
                <thead>
                  <tr>
                    <td className={headCell}>HSN/SAC</td>
                    <td className={cn(headCell, 'text-right')}>
                      Taxable Value
                    </td>
                    {isInterState ? (
                      <td className={cn(headCell, 'text-right')}>IGST</td>
          ...
          <tr>
            ...
            <td
              className={cn(cell, 'align-bottom text-right')}
              colSpan={cols - (isInterState ? 6 : 7)}
            >
